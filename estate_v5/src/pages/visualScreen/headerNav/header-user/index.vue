<template>
  <span class="i-layout-header-trigger i-layout-header-trigger-min" style="display: flex; align-items: center">
    ...
    <Dropdown :trigger="isMobile ? 'click' : 'hover'" transfer class="i-layout-header-user" transfer-class-name="vis-Drop-down" :class="{ 'i-layout-header-user-mobile': isMobile }" @on-click="handleClick">
