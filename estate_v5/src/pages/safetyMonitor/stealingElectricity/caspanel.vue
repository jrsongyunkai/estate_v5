<template>
  <span>
    <ul v-if="data && data.length" :class="[prefixCls + '-menu']">
      <Casitem v-for="item in data" :key="getKey()" :prefix-cls="prefixCls" :data="item" :tmp-item="tmpItem" @click.native.stop="handleClickItem(item, $event)" @mouseenter.native.stop="handleHoverItem(item)"></Casitem>
    </ul>
...
<script>
  ...
  import Emitter from '../../../../node_modules/view-design/src/mixins/emitter' // '../../mixins/emitter';
  import { findComponentUpward, findComponentDownward } from '../../../../node_modules/view-design/src/utils/assist' // '../../utils/assist';
