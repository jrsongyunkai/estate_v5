<template>
  <div>
    ...
    <OperationCheckAuth ref="operationCheckAuth" :action="refundOffline" title="线下退费" isAlways>
...
<script>
  import { refundOffline } from '../request/api'
  export default {
    props: {
    ...
    methods: {
      onConfirm() {
        if (this.amount === 0) return this.$Message.warning('请输入退费金额')
