<template>
  <div :class="wrapClasses">
    <template v-if="type !== 'textarea'">
      ...
      <span class="ivu-input-suffix" v-else-if="passwords" @click="handleToggleShowPassword">
...
<script>
  import { oneOf, findComponentUpward } from '../../../node_modules/view-design/src/utils/assist'
  import calcTextareaHeight from '../../../node_modules/view-design/src/utils/calcTextareaHeight'
  import Emitter from '../../../node_modules/view-design/src/mixins/emitter'
  import mixinsForm from '../../../node_modules/view-design/src/mixins/form' // '../../mixins/form';
  ...
  export default {
    ...
    props: {
      type: {
        validator(value) {
          return oneOf(value, ['text', 'textarea', 'passwords', 'url', 'email', 'date', 'number', 'tel'])
        },
        default: 'text',
      },
      value: {
    ...
    computed: {
      currentType() {
        let type = this.type
        if (type === 'passwords' && this.passwords && this.showPassword) type = 'text'
        return type
      },
      prepend() {
        let state = false
