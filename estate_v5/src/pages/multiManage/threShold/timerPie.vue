<template>
  <div class="piecontent">
    <template v-if="porea">
      <span class="pm" :style="porea.pmAM[0]" sty>PM</span>
      <span class="am" :style="porea.pmAM[1]">AM</span>
    </template>
    <div :id="uniqueID" :style="baseStyle" class="pie" style="width: '100%'"></div>
  </div>
</template>
<script>
      ...
      init() {
        if (this.options) {
          ...
          var colors2 = [
            ...
            'rgba(162, 206, 89, 0.2)',
            'rgba(10, 185, 155, 0.2)',
            'rgba(217, 226, 241, 0.2)',
            'rgba(0, 187, 242, 0.2)',
            'rgba(0, 213, 221,.2)',
            'rgba(218, 0, 232,.2)',
            'rgba(234, 84, 32,.2)',
            'rgba(106, 110, 119, 0.2)',
            'rgba(16, 130, 255, 0.2)',
            'rgba(255, 185, 43, 0.2)',
            'rgba(214, 60, 60, 0.2)',
            'rgba(233, 100, 100, 0.2)',
            'rgba(51, 149, 255, 0.2)',
            'rgba(0, 186, 128, 0.2)',
            'rgba(0, 206, 142, 0.2)',
            'rgba(26, 200, 157, 0.2)',
